...
namespace D3D11Hook
{
    ...
    static void UpdateActorCacheNoThrow()
    {
        __try
        {
    ...
    static void RenderMenuNoThrow(IDXGISwapChain* pSwapChain)
    {
        __try
        {
