...
namespace ImGuiMenu
{
    ...
    struct MenuSettings
    {
        ...
        float Ch025U2MoveSpeedXY = 1.0f;
        float Ch025U2MoveSpeedZUp = 1.0f;
        float Ch025U2MoveSpeedZDown = 1.0f;
        float Ch025U2ReinforceMoveSpeedXY = 1.0f;
        float Ch025U2ReinforceMoveSpeedZUp = 1.0f;
        float Ch025U2ReinforceMoveSpeedZDown = 1.0f;
        float Ch025U2ActivityLimitTime = 1.0f;
        float Ch025U2ActivityLowestTime = 1.0f;
        float Ch025U2ShockWaveMagRateL1 = 1.0f;
        float Ch025U2ShockWaveMagRateL2 = 1.0f;
        float Ch025U2ShockWaveMagRateL3 = 1.0f;
        float Ch025U2ActionMagRateL1 = 1.0f;
        float Ch025U2ActionMagRateL2 = 1.0f;
        float Ch025U2ActionMagRateL3 = 1.0f;
        float Ch025U3InitialVerticalSpeed = 1.0f;
        float Ch025U3LastVerticalSpeed = 1.0f;
        float Ch025U3Span = 1.0f;
        float Ch025U3WaitTurnTime = 1.0f;
        float Ch025U3ApplyInertiaSpawn = 1.0f;
        float Ch025U3ApplyInertiaSpawnHRate = 1.0f;
        float Ch025U3ApplyInertiaSpawnVRate = 1.0f;
        float Ch025U3ConditionTimeL1 = 1.0f;
        float Ch025U3ConditionTimeL2 = 1.0f;
        float Ch025U3ConditionTimeL3 = 1.0f;
        float Ch025U3BarrierValueL1 = 1.0f;
        float Ch025U3BarrierValueL2 = 1.0f;
        float Ch025U3BarrierValueL3 = 1.0f;
        float Ch025U3BarrierValueAllyL1 = 1.0f;
        float Ch025U3BarrierValueAllyL2 = 1.0f;
        float Ch025U3BarrierValueAllyL3 = 1.0f;
        float Ch025U3TurnAngleDeg = 1.0f;
        float Ch025U3TurnTime = 1.0f;
        float Ch025U3TurnBlendExp = 1.0f;
        int Ch025U3TurnSteps = 1;
        float Ch025U3ManyAllyBarrierRate = 1.0f;
        float Ch025U3OwnerBarrierListValue = 1.0f;
        float Ch025U3AllyBarrierListValue = 1.0f;
        float Ch025SpecialLowGravityTime = 1.0f;
        float Ch025SpecialStartSpeed = 1.0f;
        float Ch025SpecialMiddleSpeed = 1.0f;
        float Ch025SpecialEndSpeed = 1.0f;
        float Ch025SpecialStartSpan = 1.0f;
        float Ch025SpecialEndSpan = 1.0f;
        float Ch025SpecialDashTime = 1.0f;
        float Ch025SpecialStartVerticalSpeed = 1.0f;
        float Ch025SpecialMiddleVerticalSpeed = 1.0f;
        float Ch025SpecialEndVerticalSpeed = 1.0f;
        float Ch025SpecialStartVerticalSpan = 1.0f;
        float Ch025SpecialEndVerticalSpan = 1.0f;
        float Ch025BarrierMaxTime = 1.0f;
        float Ch025BarrierDurability = 1.0f;
        float Ch025BarrierCopyRate = 1.0f;
        float Ch025RecoveryHealthValue = 1.0f;
    };
    ...
    struct HackSettings
    {
        ...
        bool EnableInfiniteSkills = false;
