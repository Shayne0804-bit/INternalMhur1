...
void UCommonStatics::DrawDebugStringWithShadow(const class UObject* WorldContextObject, const struct FVector& TextLocation, const class FString& Text, class AActor* TestBaseActor, const struct FLinearColor& TextColor, float Duration, bool bDrawShadow, float FontScale)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("CommonStatics", "DrawDebugStringWithShadow");

	Params::CommonStatics_DrawDebugStringWithShadow Parms{};
