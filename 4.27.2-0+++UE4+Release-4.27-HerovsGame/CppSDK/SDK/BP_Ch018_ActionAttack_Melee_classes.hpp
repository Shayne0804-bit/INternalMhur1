...
// BlueprintGeneratedClass BP_Ch018_ActionAttack_Melee.BP_Ch018_ActionAttack_Melee_C
// 0x0010 (0x04B0 - 0x04A0)
class UBP_Ch018_ActionAttack_Melee_C final : public UActionAttackBase
{
public:
...
public:
	...
	void ExecuteUbergraph_BP_Ch018_ActionAttack_Melee(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_Ch018_ActionAttack_Melee_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Ch018_ActionAttack_Melee_C")
	}
	static class UBP_Ch018_ActionAttack_Melee_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_Ch018_ActionAttack_Melee_C>();
	}
};
