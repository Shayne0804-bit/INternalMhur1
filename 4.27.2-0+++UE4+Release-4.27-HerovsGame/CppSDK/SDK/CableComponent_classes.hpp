...
public:
	bool AddForceIndex(int32 idx, const struct FVector& Force);
	bool ResetAnchor(int32 idx);
	bool SetAnchor(int32 idx, const struct FVector& anchorPoint);
