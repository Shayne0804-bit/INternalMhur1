...
// Function BP_ActionDamageBound.BP_ActionDamageBound_C.BP_OnPlayDamageVoiceEvent
// (Event, Protected, BlueprintCallable, BlueprintEvent)

void UBP_ActionDamageBound_C::BP_OnPlayDamageVoiceEvent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionDamageBound_C", "BP_OnPlayDamageVoiceEvent");
