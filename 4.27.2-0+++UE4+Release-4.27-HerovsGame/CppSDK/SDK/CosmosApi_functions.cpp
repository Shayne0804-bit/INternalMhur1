...
// const TArray<struct FCosmosCustomSquadMember>&RoomObserverUserList                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UNetSquad::SetCustomRoomMember(const class FString& customRoomId, const TArray<struct FCosmosCustomRoomSquadList>& RoomSquadList, const TArray<struct FCosmosCustomSquadMember>& RoomObserverUserList)
{
	static class UFunction* Func = nullptr;
	...
	Parms.RoomObserverUserList = std::move(RoomObserverUserList);
...
// const class FString&                    MyRoomData                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNetSquad::SetMyRoomData(const class FString& squadId, const class FString& MyRoomData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NetSquad", "SetMyRoomData");

	Params::NetSquad_SetMyRoomData Parms{};

	Parms.squadId = std::move(squadId);
	Parms.MyRoomData = std::move(MyRoomData);
