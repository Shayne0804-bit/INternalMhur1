...
struct BP_ActionAirDashEnd_C_ExecuteUbergraph_BP_ActionAirDashEnd final
{
public:
...
struct BP_ActionAirDashEnd_C_BP_OnEndAction final
{
public:
...
// 0x0008 (0x0008 - 0x0000)
struct BP_ActionAirDashEnd_C_BP_OnBeginAction final
{
public:
...
struct BP_ActionAirDashEnd_C_BP_IsEnableShiftAction final
{
public:
	class FName                                   nextAction;                                        // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
