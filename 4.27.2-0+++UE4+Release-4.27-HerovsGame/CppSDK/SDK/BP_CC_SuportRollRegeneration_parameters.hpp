...
struct BP_CC_SuportRollRegeneration_C_ExecuteUbergraph_BP_CC_SuportRollRegeneration final
{
public:
...
struct BP_CC_SuportRollRegeneration_C_BP_OnUpdateIntervalValue final
{
public:
