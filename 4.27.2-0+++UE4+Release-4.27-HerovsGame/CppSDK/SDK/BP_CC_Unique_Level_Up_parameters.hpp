...
struct BP_CC_Unique_Level_Up_C_ExecuteUbergraph_BP_CC_Unique_Level_Up final
{
public:
...
DUMPER7_ASSERTS_BP_CC_Unique_Level_Up_C_ExecuteUbergraph_BP_CC_Unique_Level_Up;

// Function BP_CC_Unique_Level_Up.BP_CC_Unique_Level_Up_C.BP_OnUpdateIntervalValue
// 0x0004 (0x0004 - 0x0000)
struct BP_CC_Unique_Level_Up_C_BP_OnUpdateIntervalValue final
{
public:
	float                                         value;                                             // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_CC_Unique_Level_Up_C_BP_OnUpdateIntervalValue;
