...
public:
	...
	static void PlayAtomSoundAtLocation(const class UObject* WorldContextObject, class USoundAtomCue* Sound, const struct FVector& Location, const struct FAtomComponentParams& params);
	static void PlayAtomSoundAtLocationByName(const class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, const class FString& CueName, const struct FVector& Location, const struct FAtomComponentParams& params);
	static class UAtomComponent* PlayAtomSoundForAnimNotify(class USoundAtomCue* Sound, const struct FAtomComponentParams& params, class USceneComponent* AttachToComponent, class FName AttachPointName, const struct FVector& Location, bool bStopWhenAttachedToDestroyed, float volumeMultiplier, float pitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings, bool bFollow);
	...
	static class UAtomComponent* SpawnAtomSound2D(const class UObject* WorldContextObject, class USoundAtomCue* Sound, const struct FAtomComponentParams& params, bool bPersistAcrossLevelTransition, bool bAutoDestroy);
	static class UAtomComponent* SpawnAtomSound2DByName(const class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, const class FString& CueName, const struct FAtomComponentParams& params, bool bPersistAcrossLevelTransition, bool bAutoDestroy);
	static class UAtomComponent* SpawnAtomSoundAtLocation(const class UObject* WorldContextObject, class USoundAtomCue* Sound, const struct FVector& Location, const struct FAtomComponentParams& params, bool bAutoDestroy);
	static class UAtomComponent* SpawnAtomSoundAtLocationByName(const class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, const class FString& CueName, const struct FVector& Location, const struct FAtomComponentParams& params, bool bAutoDestroy);
	static class UAtomComponent* SpawnAtomSoundAttached(class USoundAtomCue* Sound, class USceneComponent* AttachToComponent, const struct FAtomComponentParams& params, class FName AttachPointName, const struct FVector& Location, EAttachLocation LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoDestroy);
