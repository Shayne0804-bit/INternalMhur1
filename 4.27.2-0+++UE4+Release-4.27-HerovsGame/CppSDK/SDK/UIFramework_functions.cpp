...
class FName UWidgetBase::GetOwningLevelName() const
{
	static class UFunction* Func = nullptr;
...
bool UAppWidgetWork::IsFadingIn() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AppWidgetWork", "IsFadingIn");

	Params::AppWidgetWork_IsFadingIn Parms{};
...
class ULevelStreaming* ULevelLoaderWork::GetLoadedLevel(const class FString& longPackageName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelLoaderWork", "GetLoadedLevel");

	Params::LevelLoaderWork_GetLoadedLevel Parms{};
...
void UWidgetGeneralSelectiveWindow::OnListViewScrolled(float ItemOffset, float DistanceRemaining)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WidgetGeneralSelectiveWindow", "OnListViewScrolled");

	Params::WidgetGeneralSelectiveWindow_OnListViewScrolled Parms{};
...
struct FVector2D UWidgetStatics::GetViewPortSizeDPI(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("WidgetStatics", "GetViewPortSizeDPI");

	Params::WidgetStatics_GetViewPortSizeDPI Parms{};
