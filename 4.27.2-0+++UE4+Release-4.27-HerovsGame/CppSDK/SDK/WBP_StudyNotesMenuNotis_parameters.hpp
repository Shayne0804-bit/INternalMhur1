...
struct WBP_StudyNotesMenuNotis_C_ExecuteUbergraph_WBP_StudyNotesMenuNotis final
{
public:
	...
	class ULevelStreamingDynamic*                 CallFunc_LoadStreamLevelSoftObjectLevel_ReturnValue; // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct WBP_StudyNotesMenuNotis_C_OnDecide final
{
public:
...
struct WBP_StudyNotesMenuNotis_C_PreConstruct final
{
public:
