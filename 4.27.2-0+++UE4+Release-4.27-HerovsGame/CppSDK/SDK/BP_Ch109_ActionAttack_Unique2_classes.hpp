...
// BlueprintGeneratedClass BP_Ch109_ActionAttack_Unique2.BP_Ch109_ActionAttack_Unique2_C
// 0x0040 (0x04E0 - 0x04A0)
class UBP_Ch109_ActionAttack_Unique2_C final : public UActionAttackBase
{
public:
	...
	bool                                          IsTargetUpDate;                                    // 0x04C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4C9[0x3];                                      // 0x04C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         HoldTime;                                          // 0x04CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                TargetDir;                                         // 0x04D0(0x000C)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsGround;                                          // 0x04DC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

public:
	void GetShotVector(float AddPichAngle, struct FVector* ShotVector);
	...
	void ExecuteUbergraph_BP_Ch109_ActionAttack_Unique2(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_Ch109_ActionAttack_Unique2_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Ch109_ActionAttack_Unique2_C")
	}
	static class UBP_Ch109_ActionAttack_Unique2_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_Ch109_ActionAttack_Unique2_C>();
	}
};
